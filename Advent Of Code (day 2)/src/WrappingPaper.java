/**
 * Created by Davide on 10/12/2015.
 */
public class WrappingPaper {

    public static void main(String args[]) {

        String assignment = "20x3x11\n" +
                "15x27x5\n" +
                "6x29x7\n" +
                "30x15x9\n" +
                "19x29x21\n" +
    ...
    public static int calculatePaperNeeded(int l, int w, int h) {
        ...
        int surfaceAreaSide1 = 2 * l * w;
        int surfaceAreaSide2 = 2 * w * h;
        int surfaceAreaSide3 = 2 * h * l;
        int addedPaper = 0;

        if ((Math.min(Math.min(surfaceAreaSide1, surfaceAreaSide2), surfaceAreaSide3)) > 1) {
            addedPaper = (Math.min(Math.min(surfaceAreaSide1, surfaceAreaSide2), surfaceAreaSide3)) / 2;
        } else {
            addedPaper = (Math.min(Math.min(surfaceAreaSide1, surfaceAreaSide2), surfaceAreaSide3));
        }

        int paperNeeded = surfaceAreaSide1 + surfaceAreaSide2 + surfaceAreaSide3 + addedPaper;
